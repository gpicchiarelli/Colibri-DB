...
extension BenchmarkCLI {
    ...
    static func runBTreeLookup(iterations: Int, flags: ScenarioFlags = ScenarioFlags(enableSysMetrics: false, noWarmup: false)) throws -> InternalBenchmarkResult {
        ...
        // Force index synchronization to ensure data is written to disk
        // Note: Removed rebuildIndexBulk() because it's no longer necessary
        // The index is kept up-to-date during inserts now
        db.flushAll()
