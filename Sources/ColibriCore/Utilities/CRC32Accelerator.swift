//
//  CRC32Accelerator.swift
//  ColibrìDB CRC32 Accelerated Checksum
//
//  Based on: Intel CRC32C instruction set optimization
//  Implements: Fast CRC32 calculation for WAL records and pages
//  Author: ColibrìDB Team
//  Date: 2025-10-26
//
//  Key Properties:
//  - Hardware acceleration when available (CRC32C instruction)
//  - Software fallback for compatibility
//  - Deterministic checksum for data integrity
//  - Zero-allocation checksum calculation
//
...
public struct CRC32Accelerator {
    ...
    public static func calculate(_ data: Data) -> UInt32 {
        return calculate(data: data)
    }
    
    /// Calculate CRC32 checksum for raw bytes
    /// - Parameter bytes: Raw bytes to checksum
    /// - Returns: CRC32 checksum value
